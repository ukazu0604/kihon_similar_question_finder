...
class TestOllamaNomicEmbedTextSimple(unittest.TestCase):
    """Ollamaの 'nomic-embed-text' モデルがベクトルを生成できるか、最小限のテストを行う。"""
    
    def test_nomic_embed_text_vectorization(self):
        """'nomic-embed-text'モデルでベクトル化を試みる。"""
